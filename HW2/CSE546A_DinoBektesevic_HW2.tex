...
\lstinputlisting[language=Python,firstline=451,lastline=454]{HW2_code_solutions/coordinate_descent.py}
\end{enumerate}
...
\lstinputlisting[language=Python,firstline=309, lastline=453]{HW2_code_solutions/coordinate_descent.py}
\lstinputlisting[language=Python,firstline=455]{HW2_code_solutions/coordinate_descent.py}
\end{enumerate}
