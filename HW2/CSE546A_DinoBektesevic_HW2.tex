...
\begin{enumerate}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.8\textwidth]{HW2/HW2_plots/A5ZerosVSLambdas.png}
    \end{figure}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.8\textwidth]{HW2/HW2_plots/MSEA5.png}
    \end{figure}
    ...
    Maximal value of w 0.0650 belongs to feature PctIlleg
    Maximal value of w -0.0440 belongs to feature PctKids2Par
