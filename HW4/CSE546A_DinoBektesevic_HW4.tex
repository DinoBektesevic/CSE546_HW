...
\begin{enumerate}
    ...
    \begin{figure}[h!]
        \centering 
        \subfloat[]{{\includegraphics[width=0.47\textwidth]{HW4/HW4_plots/A3a_h32.png} }}\\
        \subfloat[]{{\includegraphics[width=0.47\textwidth]{HW4/HW4_plots/A3a_h64.png} }}\\
        \subfloat[]{{\includegraphics[width=0.47\textwidth]{HW4/HW4_plots/A3a_h128.png} }}
