...
\begin{enumerate}
    ...
    I retrieve the 5th and 95th percentile interval of the given expression to be from 0.132 to 0.364. The interval does not contain zero, therefore we conclude we are 95\% confident that there is a statistically significant evidence in favor of fitting with the RBF kernel. 
\end{enumerate}
