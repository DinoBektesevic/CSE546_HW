...
\begin{enumerate}
    ...
    \begin{figure}[h!]
    \centering 
        \subfloat[Cross validation error]{{\includegraphics[width=0.4\textwidth]{HW3/HW3_plots/A3d_PolyFit.png} }}
        \subfloat[Best fitting kernel plot.]{{\includegraphics[width=0.4\textwidth]{HW3/HW3_plots/A3d_PolyBasis.png} }} \\
        \subfloat[Bootstrapped CIs]{{\includegraphics[width=0.4\textwidth]{HW3/HW3_plots/A3d_PolyBootstrapCI.png} }}
        \caption{Part a-c using Polynomial kernel}
    \end{figure}
    \begin{figure}[h!]
    \centering 
        \subfloat[Cross validation error]{{\includegraphics[width=0.4\textwidth]{HW3/HW3_plots/A3d_RBFFit.png} }}
        \subfloat[Best fitting kernel plot.]{{\includegraphics[width=0.4\textwidth]{HW3/HW3_plots/A3d_RBFBasis.png} }} \\
        \subfloat[Bootstrapped CIs]{{\includegraphics[width=0.4\textwidth]{HW3/HW3_plots/A3d_RBFBootstrapCI.png} }}
        \caption{Part a-c using Polynomial kernel}
    \end{figure}
